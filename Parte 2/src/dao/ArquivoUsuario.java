...
import src.model.RegistroUsuario;

public class ArquivoUsuario<T extends RegistroUsuario> {
    private static final int TAM_CABECALHO = 12;
    private RandomAccessFile arquivo;
    private String nomeArquivo;
    private Constructor<T> construtor;

    public ArquivoUsuario(String nomeArquivo, Constructor<T> construtor) throws Exception {
