...
import src.model.RegistroAtividade;

public class ArquivoAtividade<T extends RegistroAtividade> {
    private static final int TAM_CABECALHO = 12;
    private RandomAccessFile arquivo;
    private String nomeArquivo;
    private Constructor<T> construtor;

    public ArquivoAtividade(String nomeArquivo, Constructor<T> construtor) throws Exception {
