...
import src.model.RegistroCategoria;

public class ArquivoCategoria<T extends RegistroCategoria> {
    private static final int TAM_CABECALHO = 12;
    private RandomAccessFile arquivo;
    private String nomeArquivo;
    private Constructor<T> construtor;

    public ArquivoCategoria(String nomeArquivo, Constructor<T> construtor) throws Exception {
