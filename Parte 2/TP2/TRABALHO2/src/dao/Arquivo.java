...
public class Arquivo<T extends Registro> {
    ...
    public Arquivo(String nomeArquivo, Constructor<T> construtor) throws Exception {
        ...
        // Inicializar árvore B+
        //File arvoreBMaisFile = new File("./dados/" + nomeArquivo + "/arvore_bmais.db");
        //relviagemUsuarioArvoreBMais = new ArvoreBMais<>(arvoreBMaisFile.getAbsolutePath());
